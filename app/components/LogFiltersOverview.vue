...
const sections = computed(() => [
  ...
  { key: 'filterByUserGroups', label: 'Groups', icon: '🗺️', type: 'info' as TagType, extraClass: 'chip--group', items: statUserGroups.value.map(([v, c]) => ({ value: v as string, count: c })) },
